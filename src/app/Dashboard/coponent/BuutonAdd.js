...
const BuutonAdd = ({ addText, nameFunc }) => {
  ...
  return (
    <button
      ...
      className=" flex items-center  gap-2 bg-indigo-800 shadow-lg hover:bg-primaryV2 transition text-white px-2 text-xs py-2 rounded-md ">
      اضافة {addText}
      <svg
        width="15px"
        height="15px"
