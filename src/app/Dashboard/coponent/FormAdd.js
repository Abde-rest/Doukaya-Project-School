...
const FormAdd = () => {
  return (
    <div
      className={`backdrop-blur-sm fixed top-1/2 left-1/2   duration-300 -translate-y-1/2  -translate-x-1/2 z-40 w-full h-full flex items-center  `}>
      <div class="   m-auto p-6 bg-white rounded-lg shadow-lg h-4/5 md:h-fit overflow-y-auto ">
